...
public class StatusBarUtil {
    ...
    /**
     * 设置状态栏高度
     * @param isBlackText true 字体颜色为黑色，false为白色
     * @param isFullMode  是否在全屏模式下
     */
    public static void setBarTextColor(final Activity activity, final boolean isBlackText, boolean isFullMode) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            switch (DEVICE_FIRM) {
                case AvailableRomType.MIUI:
                    MIUISetStatusBarLightMode(activity, isBlackText);
                    break;

                case AvailableRomType.FLYME:
                    if (Build.VERSION.SDK_INT > Build.VERSION_CODES.M) {
                        setAndroidNativeLightStatusBar(activity, isBlackText, isFullMode);
                    } else {
                        setFlymeLightStatusBar(activity, isBlackText);
                    }
                    break;
...
//    public static void setBarTextColor(final Window window, final boolean dark, boolean isFullMode) {
